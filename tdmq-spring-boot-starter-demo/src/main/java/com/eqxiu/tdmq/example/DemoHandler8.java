 ...
 */
@Component
@TdmqHandler(topics = {@TdmqTopic(topic = "${eqxiu.scs.mns.topics.content-todo-8.topic}",
        tags = "${eqxiu.scs.mns.topics.content-todo-8.tags}")})
public class DemoHandler8 implements TdmqBatchListener<String> {

    @Override
    public void received(Consumer<String> consumer, Messages<String> messages) throws MessageRedeliverException {
        System.out.println("DemoHandler8:" + messages.size());
    }
}
