 ...
 */
@Component
@TdmqHandler(topics = {@TdmqTopic(topic = "${eqxiu.scs.mns.topics.content-todo-7.topic}",
        tags = "${eqxiu.scs.mns.topics.content-todo-7.tags}")})
public class DemoHandler7 implements TdmqBatchListener<String> {

    @Override
    public void received(Consumer<String> consumer, Messages<String> messages) throws MessageRedeliverException {
        System.out.println("DemoHandler7:" + messages.size());
    }
}
